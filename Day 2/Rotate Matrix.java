...
// Two Approaches : 1) use extra matrix and copy first as the last column of new matrix and accordingly copy entire matrix
//                  2) First find transpose of matrix and then reverse the each row of the matrix
