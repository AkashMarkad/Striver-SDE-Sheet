...
// 3. By Dutch National Flag Algorithm - It's Most optimal way to solve the dutch 012 sort. In this algorithm we take low, mid and high pointers. Initially low and mid assighned to 0 index and high assigned to the last index. And swap if mid at 0 then with the 0 and if mid at 2 then with high And if mid is 1 then increase mid by 1.
